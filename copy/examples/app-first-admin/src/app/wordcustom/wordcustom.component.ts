...
@Component({
  selector: 'app-wordcustom',
  templateUrl: './wordcustom.component.html',
  styleUrls: ['./wordcustom.component.css']
})
export class WordcustomComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dictionaryForm = this.formBuilder.group({
      ...
      modalCustomNameLang: ['', Validators.required]/*,
